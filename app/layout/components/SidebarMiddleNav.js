...
export const SidebarMiddleNav = () => (
  <SidebarMenu>
    ...
    <SidebarMenu.Item
      ...
      title="Master Data"
    >
      <SidebarMenu.Item title="Tahun Ajaran" to='/dashboards/analytics' exact />
      <SidebarMenu.Item title="Kelas" to='/dashboards/projects' exact />
      <SidebarMenu.Item title="Siswa" to='/dashboards/system' exact />
      <SidebarMenu.Item title="Pegawai" to='/master-data/pegawai' exact />
      <SidebarMenu.Item title="Mata Pelajaran" to='/dashboards/financial' exact />
    </SidebarMenu.Item>
    <SidebarMenu.Item
